...
class PieServer:
    def __init__(self,
                 ...
                 version_name="1.20.12",
                 protocol_version=594,
                 max_players=20,
                 gamemode="survival",
                 guid=random.randint(1, 99999999),
                 raknet_version=11,
                 timeout=20
                 ):
        self.threads = []
        ...
        self.raknet_server = self.bedrock_server.raknet_server

        self.network_thread = threading.Thread(target=self.bedrock_server.start)
